...
INSERT INTO flights (flight_number, departure_airport, arrival_airport, departure_time, arrival_time, price_cents,
                     total_seats, status)
VALUES
-- Рейс 1: Казань -> Сочи (Утро 25 мая)
('N4-123', 'KZN', 'AER', '2026-05-25 08:30:00', '2026-05-25 12:00:00', 1250000, 6, 'scheduled'),

-- Рейс 2: Москва -> Минск (Вечер 25 мая)
('B2-999', 'VKO', 'MSQ', '2026-05-25 19:45:00', '2026-05-25 21:10:00', 850000, 4, 'scheduled'),

-- Рейс 3: Екб -> Пхукет (Ночь 26 мая)
('ZF-777', 'SVX', 'HKT', '2026-05-26 01:00:00', '2026-05-26 10:30:00', 6500000, 5, 'scheduled');
